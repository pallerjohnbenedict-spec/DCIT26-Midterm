  ...
  export default function App() {
    ...
    return (
      <div style={{ fontFamily: "Inter, sans-serif", background: "#121212", color: "white" }}>
        <Navbar />
        ...
        >
          ...
          >
            ...
            >
              22-year-old Computer Science student from Parañaque City. I’m passionate about technology and software development, always eager to learn new things and build creative digital projects. I love traveling, playing Mobile Legends, and spending time with my pets — my dog and my cat named Siopao.
            </motion.p>
          </motion.div>
        </section>
    ...
    >
      {[
        ...
        >
          ...
          />
          <h3 style={{ fontSize: "1rem", color: "#e5e7eb" }}>{skill.title}</h3>
        </motion.div>
      ))}
    </div>
  </section>
  ...
  🔗 Open homepage.html
        ...
        >
          ...
          >
                ...
                {[
                  {
                    ...
                    href: "mailto:pallerjohnbenedict@gmail.com",
                  },
                  {
                    icon: "💬",
            ...
            >
              <p style={{ color: "#ddd", fontSize: "1rem", marginBottom: "20px" }}>
